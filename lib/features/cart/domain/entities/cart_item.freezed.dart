...
/// @nodoc
mixin _$CartItem {
  GasCylinder get cylinder => throw _privateConstructorUsedError;
...
class _$CartItemCopyWithImpl<$Res, $Val extends CartItem>
  ...
  $GasCylinderCopyWith<$Res> get cylinder {
    return $GasCylinderCopyWith<$Res>(_value.cylinder, (value) {
      return _then(_value.copyWith(cylinder: value) as $Val);
    });
  }
}
...
class _$CartItemImpl implements _CartItem {
  const _$CartItemImpl({required this.cylinder, this.quantity = 1});
  ...
  @override
  String toString() {
    return 'CartItem(cylinder: $cylinder, quantity: $quantity)';
  }
...
abstract class _CartItem implements CartItem {
  const factory _CartItem(
      {required final GasCylinder cylinder,
